...
def training(stock, start_date, end_date) :
...
# print(df)
    ...
    start = time.time()
    model.fit(x_train, y_train, batch_size=11, epochs=11)
    end = time.time()
...
#training(stock1, start_date1, end_date1, 'C:/Users/admin/PycharmProjects/Predictor-bot')
